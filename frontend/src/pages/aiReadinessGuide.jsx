    ...
    <main className="bg-zinc-950 text-zinc-100 min-h-screen">
      ...
      <section className="relative overflow-hidden px-6 pb-4" style={{ paddingTop: "110px" }}>
        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          <p className="text-zinc-500 text-sm leading-relaxed mb-5 max-w-xl">
          ...
          <a
            ...
            className="inline-block bg-emerald-500 hover:bg-emerald-400 text-black font-semibold px-6 py-3 rounded-xl transition text-sm"
          >
            Get the free guide ↓
          </a>
        </div>
