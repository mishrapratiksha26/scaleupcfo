    ...
    >
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="section-header text-center mb-12">
          <h2 className="text-4xl font-bold text-foreground">Pricing Built for Scale</h2>
...
>
        ...
        <div className="mt-6 text-center">
          <CalBookingButton
            ...
            className="inline-block px-3 py-1.5 bg-primary text-primary-foreground text-sm font-medium rounded-md hover:brightness-110 hover:shadow-md transition-all duration-300 max-w-[120px]"
          />
        </div>
      </div>
    );
